...
class PotholeDataset(utils.Dataset):
    ...
    def load_pothole(self, dataset_dir, subset):
        ...
        dataset_dir = "~/Project/Mask_RCNN-master/samples/Pothole/dataset"
        ...
        for a in annotations:
            ...
            image_path = os.path.join("dataset/training", a['filename'])
            images=([cv2.imread(file) for file in glob.glob("dataset/training/frame1650.jpg")])
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        mask = np.zeros([1920, info["width"], len(info["polygons"])],
                        dtype=np.uint8)
